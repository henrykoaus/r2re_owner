...
class AddressAmendmentPage extends StatefulWidget {
  const AddressAmendmentPage({
    super.key,
  });

  @override
  State<AddressAmendmentPage> createState() => _AddressAmendmentPageState();
}

class _AddressAmendmentPageState extends State<AddressAmendmentPage> {
  ...
  Visibility editButton(BuildContext context) {
    return Visibility(
      visible: dataList.isNotEmpty ? false : true,
      child: GestureDetector(
        onTap: () async {
          ...
          if (selectedData.isNotEmpty || selectedData != '') {
            ...
            generalDialog(context, '입력한 주소를 다시 확인해주세요.');
          }
        },
        child: Container(
